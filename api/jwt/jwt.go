...
func ParseToken(val string) (id int64, err error) {
	...
	case nil:
		...
		if !ok {
			return 0, errors.New("Token is invaild")
		}
	...
	case *jwt.ValidationError:
		...
		default:
			log.Println(vErr)
			return 0, errors.New("Errors parsing token")
		}
	default:
		return 0, errors.New("Unable to parse token or token does not exist in request")
	}
}
